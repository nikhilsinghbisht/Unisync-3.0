...
public class LoadDatabaseConfiguration {
    ...
    private static final int MIN_POSTS_PER_USER = 0;
    ...
    private List<User> createUsers(UserRepository userRepository) {
        List<String> firstNames = Arrays.asList("John", "Jane");

        List<String> lastNames = Arrays.asList("Smith", "Johnson");

        List<String> companies = Arrays.asList("Google", "Microsoft");

        List<String> positions = Arrays.asList("Software Engineer", "Data Scientist");
