            ...
            <div className={classes.top}>
              <button onClick={() => navigate(`/profile/${conversationUserToDisplay?.id}`)}>
                <img
                  ...
                  src={`${BASE_URL}${conversationUserToDisplay?.profilePicture}` || "/avatar.svg"}
                  alt=""
                />
              </button>
              <div>
            ...
            <form className={`${classes.form} ${classes.new}`} onSubmit={(e) => e.preventDefault()}>
              ...
              {slectedUser && (
                <div className={classes.top}>
                  <img
                    className={classes.avatar}
                    src={`${BASE_URL}${slectedUser.profilePicture} `|| "/avatar.svg"}
                    alt="TestUser-dev1"
                  />
                  <div>
                    <div className={classes.name}>
                  ...
                  {suggestingUsers
                    ...
                    .map((user) => (
                      ...
                      >
                        <img
                          className={classes.avatar}
                          src={`${BASE_URL}${user.profilePicture}` || "/avatar.svg"}
                          alt=""
                        />
                        <div>
                          <div className={classes.name}>
